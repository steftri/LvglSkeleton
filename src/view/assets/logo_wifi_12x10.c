...
#ifndef LV_ATTRIBUTE_IMAGE_LOGO_WIFI_12X10
#define LV_ATTRIBUTE_IMAGE_LOGO_WIFI_12X10
#endif

const LV_ATTRIBUTE_MEM_ALIGN LV_ATTRIBUTE_LARGE_CONST LV_ATTRIBUTE_IMAGE_LOGO_WIFI_12X10 uint8_t logo_wifi_12x10_map[] = {
  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 
  0x00, 0x00, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0x00, 0x00, 0x00, 0x00, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0x00, 0x00, 
...
const lv_image_dsc_t logo_wifi_12x10 = {
  .header.cf = LV_COLOR_FORMAT_RGB565,
  .header.magic = LV_IMAGE_HEADER_MAGIC,
  .header.w = 12,
  .header.h = 10,
  .data_size = 120 * 2,
  .data = logo_wifi_12x10_map,
};
