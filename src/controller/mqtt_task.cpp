...
void MqttTask::onConnected()
{
  ...
  doc["dataModel"]["measurements"][0]["unit"] = "%";
  doc["dataModel"]["measurements"][1]["name"] = "ChargingCurrent";
  doc["dataModel"]["measurements"][1]["type"] = "float";
  doc["dataModel"]["measurements"][1]["unit"] = "A";
  doc["dataModel"]["measurements"][2]["name"] = "ChargingPower";
  doc["dataModel"]["measurements"][2]["type"] = "float";
  doc["dataModel"]["measurements"][2]["unit"] = "kW";
  doc["dataModel"]["measurements"][3]["name"] = "ChargedEnergy";
  doc["dataModel"]["measurements"][3]["type"] = "float";
  doc["dataModel"]["measurements"][3]["unit"] = "kWh";
  doc["dataModel"]["measurements"][4]["name"] = "ChargingDuration";
  doc["dataModel"]["measurements"][4]["type"] = "uint32";
  doc["dataModel"]["measurements"][4]["unit"] = "s";
